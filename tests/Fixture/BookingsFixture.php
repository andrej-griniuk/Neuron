...
class BookingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'lesson_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'user_id' => 1,
            'lesson_id' => 1,
            'created' => '2015-05-09 11:51:52',
            'modified' => '2015-05-09 11:51:52'
        ],
    ];
}
